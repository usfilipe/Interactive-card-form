...
const cnumber = document.getElementById('c-number-d')
...
input_credit_card(document.getElementById('c-number'))

function verifica() {
  if (number.value == 0) {
    errorN.classList.remove('hidde')
    number.classList.add('error')
  } else {
    number.classList.remove('error')
    errorN.classList.add('hidde')
  }
}
